...
namespace ApiCatalogoLogos.Controllers.V1
{
    ...
    {
        public readonly IExemploSingleton _exemploSingleton1; //gera uma instância que fica até o final do ciclo de vida do projeto
        public readonly IExemploSingleton _exemploSingleton2;

        public readonly IExemploScoped _exemploScoped1; // perdura durante toda a requisição
        public readonly IExemploScoped _exemploScoped2;

        public readonly IExemploTransient _exemploTransient1; // cada vez que é injetado ele dá uma instância nova
